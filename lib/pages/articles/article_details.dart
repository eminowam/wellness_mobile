    ...
    icon: const Icon(Icons.close,color: Colors.white,),
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            children: [
              Text("В стране чудес жила была одна принцесса",
                style: TextStyle(
